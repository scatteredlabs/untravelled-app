...
import 'package:untravelled_app/core/widgets/tooltip/tooltip.dart';
...
class TooltipShape extends ShapeBorder {
  ...
  Path getOuterPath(Rect rect, {TextDirection? textDirection}) {
    ...
    Path getLeftTopPath(Rect rect) {
      return Path()
        ...
        ..arcToPoint(
          ...
          radius: UntravelledSquircleRadius(cornerRadius: topLeftRadius),
        )
        ..lineTo(rect.right - topRightRadius, rect.top)
        ..arcToPoint(
          Offset(rect.right, rect.top + topRightRadius),
          radius: UntravelledSquircleRadius(cornerRadius: topRightRadius),
        );
    }
    ...
    Path getBottomRightPath(Rect rect) {
      return Path()
        ...
        ..arcToPoint(
          ...
          radius: UntravelledSquircleRadius(cornerRadius: bottomRightRadius),
          clockwise: false,
        )
    ...
    if (tooltipPosition == UntravelledTooltipPosition.right) {
      tooltipCenter = rect.centerLeft.translate(-arrowLength - arrowTipDistance, 0);
    } else if (tooltipPosition == UntravelledTooltipPosition.left) {
      ...
      case UntravelledTooltipPosition.top:
        return getLeftTopPath(rect)
          ...
          ..arcToPoint(
            ...
            radius: UntravelledSquircleRadius(cornerRadius: bottomLeftRadius),
          )
          ..lineTo(rect.left, rect.top + topLeftRadius)
          ..arcToPoint(
            Offset(rect.left + topLeftRadius, rect.top),
