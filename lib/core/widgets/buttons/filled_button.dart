...
class UntravelledFilledButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final Color effectiveBackgroundColor = backgroundColor ??
        context.untravelledTheme?.buttonTheme.colors.filledVariantBackgroundColor ??
        UntravelledColors.light.piccolo;

    final Color effectiveTextColor =
        context.untravelledTheme?.buttonTheme.colors.filledVariantTextColor ?? UntravelledColors.light.goten;
