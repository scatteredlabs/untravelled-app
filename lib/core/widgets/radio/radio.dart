...
import 'package:untravelled_app/core/widgets/radio/radio_painter.dart';

class UntravelledRadio<T> extends StatefulWidget {
  ...
  static Widget withLabel<T>(
    ...
    final Color effectiveTextColor = context.untravelledTheme?.radioTheme.colors.textColor ?? UntravelledColors.light.textPrimary;

    final TextStyle effectiveTextStyle =
        context.untravelledTheme?.radioTheme.properties.textStyle ?? UntravelledTypography.typography.body.textDefault;
  ...
  @override
  State<UntravelledRadio<T>> createState() => _RadioState<T>();
}

class _RadioState<T> extends State<UntravelledRadio<T>> with TickerProviderStateMixin, ToggleableStateMixin {
  final UntravelledRadioPainter _painter = UntravelledRadioPainter();
  ...
  @override
  void didUpdateWidget(UntravelledRadio<T> oldWidget) {
  ...
  Widget build(BuildContext context) {
    ...
    final Color effectiveActiveColor =
        widget.activeColor ?? context.untravelledTheme?.radioTheme.colors.activeColor ?? UntravelledColors.light.piccolo;

    final Color effectiveInactiveColor =
        widget.inactiveColor ?? context.untravelledTheme?.radioTheme.colors.inactiveColor ?? UntravelledColors.light.trunks;
