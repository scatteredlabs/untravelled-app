...
import 'package:untravelled_app/core/widgets/text_input/text_input.dart';

export 'package:flutter/services.dart'
    show SmartDashesType, SmartQuotesType, TextCapitalization, TextInputAction, TextInputType;

typedef UntravelledFormTextInputErrorCallback = void Function(String? errorText);

/// A [FormField] that contains a [UntravelledTextInput].
///
/// This is a convenience widget that wraps a [UntravelledTextInput] widget in a
/// [FormField].
///
...
/// {@tool snippet}
///
/// Creates a [UntravelledFormTextInput] with a validator function.
///
/// ![If the user enters valid text, the UntravelledTextInput appears normally without any warnings to the user](https://flutter.github.io/assets-for-api-docs/assets/material/text_form_field.png)
///
/// ![If the user enters invalid text, the error message returned from the validator function is displayed in dark red underneath the input](https://flutter.github.io/assets-for-api-docs/assets/material/text_form_field_error.png)
class UntravelledFormTextInput extends StatefulWidget {
  ...
  /// The height of the form text input (this does not include the space taken by [UntravelledFormTextInput.errorBuilder]).
  final double? height;
  ...
  final UntravelledFormTextInputErrorCallback? onError;
  ...
  /// to [UntravelledFormTextInput.noMaxLength] then only the current character count is displayed.
  ///
  ...
  ///
  /// This value must be either null, [UntravelledFormTextInput.noMaxLength], or greater than 0.
  /// If null (the default) then there is no limit to the number of characters
  /// that can be entered. If set to [UntravelledFormTextInput.noMaxLength], then no limit will
  ...
  /// "spinner" buttons that increment and decrement a value in the [UntravelledFormTextInput]
  ...
  ///
  /// The [mouseCursor] is the only property of [UntravelledFormTextInput] that controls the
  ...
  /// The [UntravelledFormTextInput] uses this to override the [InputDecoration.errorText]
  /// value.
  ///
  /// Alternating between error and normal state can cause the height of the
  /// [UntravelledFormTextInput] to change if no other subtext decoration is set on the
  /// field. To create a field whose height is fixed regardless of whether or
  /// not an error is displayed, either wrap the  [UntravelledFormTextInput] in a fixed
  ...
  /// Creates a [FormField] that contains a [UntravelledTextInput].
  ///
  /// When a [controller] is specified, [initialValue] must be null (the
  /// default). If [controller] is null, then a [TextEditingController]
  /// will be constructed automatically and its `text` will be initialized
  /// to [initialValue] or the empty string.
  const UntravelledFormTextInput({
    //MDS props
    ...
    this.autovalidateMode = AutovalidateMode.disabled,
        ...
        assert(maxLength == null || maxLength == UntravelledFormTextInput.noMaxLength || maxLength > 0),
        // Assert the following instead of setting it directly to avoid surprising the user by silently changing the value they set.
        assert(
          !identical(textInputAction, TextInputAction.newline) ||
              maxLines == 1 ||
              !identical(keyboardType, TextInputType.text),
          'Use keyboardType TextInputType.multiline when using TextInputAction.newline on a multiline UntravelledFormTextInput.',
        ),
  ...
  @override
  State<UntravelledFormTextInput> createState() => _UntravelledTextInputState();
...
class _UntravelledTextInputState extends State<UntravelledFormTextInput> {
  @override
