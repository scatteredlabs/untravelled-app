...
import 'package:untravelled_app/core/widgets/bottom_sheet/bottom_sheet.dart';

/// Shows a modal Untravelled Design bottom sheet.
Future<T?> showUntravelledModalBottomSheet<T>({
  ...
  final Color effectiveBarrierColor =
      barrierColor ?? context.untravelledTheme?.bottomSheetTheme.colors.barrierColor ?? UntravelledColors.light.zeno;
  ...
  final T? result = await Navigator.of(context, rootNavigator: useRootNavigator).push(
    UntravelledModalBottomSheetRoute<T>(
...
class UntravelledModalBottomSheetRoute<T> extends PageRoute<T> {
  ...
  UntravelledModalBottomSheetRoute({
    super.settings,
  ...
  AnimationController createAnimationController() {
    ...
    _animationController = UntravelledBottomSheet.createAnimationController(
      navigator!.overlay!,
      transitionDuration,
    );
  ...
  @override
  bool canTransitionTo(TransitionRoute<dynamic> nextRoute) => nextRoute is UntravelledModalBottomSheetRoute;

  @override
  bool canTransitionFrom(TransitionRoute<dynamic> previousRoute) =>
      previousRoute is UntravelledModalBottomSheetRoute || previousRoute is PageRoute;
...
class _ModalBottomSheet<T> extends StatefulWidget {
  ...
  final String? semanticLabel;
  final AnimationController? animationController;
  final UntravelledModalBottomSheetRoute<T> route;
