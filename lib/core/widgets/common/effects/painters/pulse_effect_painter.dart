    ...
    if (!animation.isDismissed) {
      ...
      canvas.drawRRect(
        RRect.fromRectAndCorners(
          ...
          topLeft: UntravelledSquircleRadius(cornerRadius: topLeftLerp),
          topRight: UntravelledSquircleRadius(cornerRadius: topRightLerp),
          bottomLeft: UntravelledSquircleRadius(cornerRadius: bottomLeftLerp),
          bottomRight: UntravelledSquircleRadius(cornerRadius: bottomRightLerp),
        ),
        paint,
      );
    }
