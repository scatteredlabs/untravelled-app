    ...
    if (!animation.isDismissed) {
      ...
      canvas.drawRRect(
        RRect.fromRectAndCorners(
          ...
          topLeft: UntravelledSquircleRadius(cornerRadius: borderRadius.topLeft.x + resolvedExtent),
          topRight: UntravelledSquircleRadius(cornerRadius: borderRadius.topRight.x + resolvedExtent),
          bottomLeft: UntravelledSquircleRadius(cornerRadius: borderRadius.bottomLeft.x + resolvedExtent),
          bottomRight: UntravelledSquircleRadius(cornerRadius: borderRadius.bottomRight.x + resolvedExtent),
        ),
        paint,
      );
    }
