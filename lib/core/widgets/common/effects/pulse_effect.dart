...
import 'package:untravelled_app/core/widgets/common/effects/painters/pulse_effect_painter.dart';

class UntravelledPulseEffect extends StatefulWidget {
  final bool show;
  ...
  @override
  State<UntravelledPulseEffect> createState() => _UntravelledPulseEffectState();
}

class _UntravelledPulseEffectState extends State<UntravelledPulseEffect> with SingleTickerProviderStateMixin {
  ...
  late final AnimationController _animationController = AnimationController(
    ...
    debugLabel: "UntravelledPulseEffect animation controller",
  );
  ...
  @override
  void didUpdateWidget(covariant UntravelledPulseEffect oldWidget) {
