...
class UntravelledLinearProgressIndicatorPainter extends CustomPainter {
  ...
  const UntravelledLinearProgressIndicatorPainter({
  ...
  @override
  bool shouldRepaint(UntravelledLinearProgressIndicatorPainter oldPainter) {
