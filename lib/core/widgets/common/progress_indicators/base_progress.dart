...
/// A base class for Untravelled Design progress indicators.
///
/// This widget cannot be instantiated directly. For a linear progress
/// indicator, see [UntravelledLinearProgressIndicator]. For a circular progress indicator,
/// see [UntravelledCircularProgressIndicator].
abstract class UntravelledBaseProgressIndicator extends StatefulWidget {
  ...
  const UntravelledBaseProgressIndicator({
    super.key,
    this.valueColor,
