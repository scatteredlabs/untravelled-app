...
class UntravelledIcon extends StatelessWidget {
  /// Creates an icon.
  ///
  /// This is required for mobile Safari to render custom icons properly.
  const UntravelledIcon(
    this.icon, {
    super.key,
    this.size,
    this.fill,
  ...
  ///
  /// If this [UntravelledIcon] is being placed inside an [IconButton], then use
  /// [IconButton.iconSize] instead, so that the [IconButton] can make the splash
  /// area the appropriate size as well. The [IconButton] uses an [IconTheme] to
  /// pass down the size to the [UntravelledIcon].
  final double? size;
  ...
  /// sources.
  ///
  /// Shadows must be in the same order for [UntravelledIcon] to be considered as
  ...
  /// set to true, and the [UntravelledIcon] widget uses the [textDirection] to determine
