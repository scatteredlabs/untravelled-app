...
@immutable
class UntravelledAvatarSizeProperties extends ThemeExtension<UntravelledAvatarSizeProperties> with DiagnosticableTreeMixin {
  ...
  const UntravelledAvatarSizeProperties({
  ...
  @override
  UntravelledAvatarSizeProperties copyWith({
    ...
    return UntravelledAvatarSizeProperties(
  ...
  @override
  UntravelledAvatarSizeProperties lerp(ThemeExtension<UntravelledAvatarSizeProperties>? other, double t) {
    if (other is! UntravelledAvatarSizeProperties) return this;
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties
      ..add(DiagnosticsProperty("type", "UntravelledAvatarSizeProperties"))
