...
@immutable
class UntravelledAccordionColors extends ThemeExtension<UntravelledAccordionColors> with DiagnosticableTreeMixin {
  ...
  const UntravelledAccordionColors({
  ...
  @override
  UntravelledAccordionColors copyWith({
    Color? textColor,
    ...
    return UntravelledAccordionColors(
  ...
  @override
  UntravelledAccordionColors lerp(ThemeExtension<UntravelledAccordionColors>? other, double t) {
    if (other is! UntravelledAccordionColors) return this;
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties
      ..add(DiagnosticsProperty("type", "UntravelledAccordionColors"))
