...
@immutable
class UntravelledTooltipProperties extends ThemeExtension<UntravelledTooltipProperties> with DiagnosticableTreeMixin {
  ...
  const UntravelledTooltipProperties({
  ...
  @override
  UntravelledTooltipProperties copyWith({
    ...
    return UntravelledTooltipProperties(
  ...
  @override
  UntravelledTooltipProperties lerp(ThemeExtension<UntravelledTooltipProperties>? other, double t) {
    if (other is! UntravelledTooltipProperties) return this;
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties
      ..add(DiagnosticsProperty("type", "UntravelledTooltipProperties"))
