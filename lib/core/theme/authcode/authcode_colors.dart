...
@immutable
class UntravelledAuthCodeColors extends ThemeExtension<UntravelledAuthCodeColors> with DiagnosticableTreeMixin {
  ...
  const UntravelledAuthCodeColors({
  ...
  @override
  UntravelledAuthCodeColors copyWith({
    ...
    return UntravelledAuthCodeColors(
  ...
  @override
  UntravelledAuthCodeColors lerp(ThemeExtension<UntravelledAuthCodeColors>? other, double t) {
    if (other is! UntravelledAuthCodeColors) return this;
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties
      ..add(DiagnosticsProperty("type", "UntravelledAuthCodeColors"))
