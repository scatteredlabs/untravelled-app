...
@immutable
class UntravelledAuthCodeProperties extends ThemeExtension<UntravelledAuthCodeProperties> with DiagnosticableTreeMixin {
  ...
  const UntravelledAuthCodeProperties({
  ...
  @override
  UntravelledAuthCodeProperties copyWith({
    ...
    return UntravelledAuthCodeProperties(
  ...
  @override
  UntravelledAuthCodeProperties lerp(ThemeExtension<UntravelledAuthCodeProperties>? other, double t) {
    if (other is! UntravelledAuthCodeProperties) return this;
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties
      ..add(DiagnosticsProperty("type", "UntravelledAuthCodeProperties"))
