...
@immutable
class UntravelledButtonColors extends ThemeExtension<UntravelledButtonColors> with DiagnosticableTreeMixin {
  /// Button border color.
  ...
  @override
  UntravelledButtonColors copyWith({
    Color? borderColor,
    Color? textColor,
    ...
    return UntravelledButtonColors(
  ...
  @override
  UntravelledButtonColors lerp(ThemeExtension<UntravelledButtonColors>? other, double t) {
    if (other is! UntravelledButtonColors) return this;
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties
      ..add(DiagnosticsProperty("type", "UntravelledButtonColors"))
