...
@immutable
class UntravelledAlertProperties extends ThemeExtension<UntravelledAlertProperties> with DiagnosticableTreeMixin {
  ...
  const UntravelledAlertProperties({
  ...
  @override
  UntravelledAlertProperties copyWith({
    ...
    return UntravelledAlertProperties(
  ...
  @override
  UntravelledAlertProperties lerp(ThemeExtension<UntravelledAlertProperties>? other, double t) {
    if (other is! UntravelledAlertProperties) return this;
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties
      ..add(DiagnosticsProperty("type", "UntravelledAlertProperties"))
