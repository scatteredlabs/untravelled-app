...
@immutable
class UntravelledColors extends ThemeExtension<UntravelledColors> with DiagnosticableTreeMixin {
  static const light = UntravelledColors(
  ...
  static const dark = UntravelledColors(
  ...
  @override
  UntravelledColors lerp(ThemeExtension<UntravelledColors>? other, double t) {
    if (other is! UntravelledColors) return this;
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties
      ..add(DiagnosticsProperty("type", "UntravelledColors"))
