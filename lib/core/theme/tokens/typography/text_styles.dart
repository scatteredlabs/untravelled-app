...
@immutable
class UntravelledTextStyles extends ThemeExtension<UntravelledTextStyles> with DiagnosticableTreeMixin {
  static const _semiBold = FontWeight.w600;

  static const body = UntravelledTextStyles(
  ...
  static const heading = UntravelledTextStyles(
    textDefault: TextStyle(
      fontSize: 14,
  ...
  static const caption = UntravelledTextStyles(
    textDefault: TextStyle(
      fontSize: 14,
      height: 1.2,
      letterSpacing: 1,
  ...
  @override
  UntravelledTextStyles copyWith({
  ...
  @override
  UntravelledTextStyles lerp(ThemeExtension<UntravelledTextStyles>? other, double t) {
    if (other is! UntravelledTextStyles) return this;
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties
      ..add(DiagnosticsProperty("type", "UntravelledTextStyles"))
