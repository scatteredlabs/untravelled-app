...
@immutable
class UntravelledSizes extends ThemeExtension<UntravelledSizes> with DiagnosticableTreeMixin {
  static const sizes = UntravelledSizes(
    x6s: 2,
    x5s: 4,
    x4s: 8,
    x3s: 12,
  ...
  @override
  UntravelledSizes lerp(ThemeExtension<UntravelledSizes>? other, double t) {
    if (other is! UntravelledSizes) return this;
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties
      ..add(DiagnosticsProperty("type", "UntravelledSizes"))
