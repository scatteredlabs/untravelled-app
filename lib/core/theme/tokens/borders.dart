...
@immutable
class UntravelledBorders extends ThemeExtension<UntravelledBorders> with DiagnosticableTreeMixin {
  static const borders = UntravelledBorders(
  ...
  @override
  UntravelledBorders lerp(ThemeExtension<UntravelledBorders>? other, double t) {
    if (other is! UntravelledBorders) return this;
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties
      ..add(DiagnosticsProperty("type", "UntravelledBorders"))
