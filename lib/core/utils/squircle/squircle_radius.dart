...
class UntravelledSquircleRadius extends Radius {
  static const zero = UntravelledSquircleRadius(
    cornerRadius: 0,
    cornerSmoothing: 0,
  );
  ...
  const UntravelledSquircleRadius({
  ...
  @override
  Radius operator -() => UntravelledSquircleRadius(
  ...
  Radius operator -(Radius other) {
    if (other is UntravelledSquircleRadius) {
      return UntravelledSquircleRadius(
  ...
  @override
  UntravelledSquircleRadius operator *(double operand) => UntravelledSquircleRadius(
  ...
  ///
  /// If either is null, this function substitutes [UntravelledSquircleRadius.zero] instead.
  ///
  ...
  static UntravelledSquircleRadius? lerp(UntravelledSquircleRadius? a, UntravelledSquircleRadius? b, double t) {
    if (b == null) {
      if (a == null) {
        return null;
      } else {
  ...
  bool operator ==(Object other) {
    ...
    return other is UntravelledSquircleRadius &&
